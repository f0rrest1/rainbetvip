...
import { defaultSiteSettings, SiteSettings, FloatingBox } from '@/lib/defaultSettings';
      ...
      if (response.success) {
        setSettings({
          ...
          trackingPixel: {
            ...
            ...response.data.trackingPixel,
          },
          floatingBoxes: response.data.floatingBoxes || defaultSiteSettings.floatingBoxes,
        });
      }
    } catch (error) {
